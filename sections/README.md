...
| :--- | :--- |
| `concepts/` | Technical notes and concept deep-dives. |
| `exercises/` | Practice activities to reinforce each section. |
...
| **06** | **React Performance, Rendering and Optimization** | 🟡 In Progress | Concepts completed; exercises and Project 05 implementation in progress. [View Section](./06-react-performance-rendering-and-optimization/README.md) |
...
│   ├── concepts/
│   └── exercises/
└── 06-react-performance-rendering-and-optimization/
    ├── concepts/
    └── exercises/
